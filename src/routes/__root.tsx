...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SmartNotes AI — Turn Notes into Success" },
      {
        name: "description",
        content:
          "SmartNotes AI helps students study smarter with AI-powered summaries, flashcards, quizzes, and personalized study plans.",
      },
      { name: "author", content: "SmartNotes AI" },
      { property: "og:title", content: "SmartNotes AI — Turn Notes into Success" },
      {
      ...
      { name: "twitter:site", content: "@SmartNotesAI" },
    ],
    links: [
      {
        rel: "stylesheet",
